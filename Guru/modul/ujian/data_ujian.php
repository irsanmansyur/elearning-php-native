                ...
                foreach ($sqlrole as $row) { ?>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <a href="?page=ujian&act=soal&id=<?= $row['id_ujian']; ?>" class="btn btn-<?= ($jmlSoal < $row["jml_soal"]) ? "primary" : "warning"; ?> btn-sm text-white"><?= ($jmlSoal < $row["jml_soal"]) ? "Tambah Soal" : "Edit Soal"; ?> ( <b><?= $jmlSoal; ?></b> )</a>
                    </td>
                    <td>
